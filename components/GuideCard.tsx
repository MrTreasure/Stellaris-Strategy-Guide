...
export function GuideCard({ guide }: { guide: Guide }) {
  return <Link href={`/guides/${guide.slug}`} className="group corner archive-frame block overflow-hidden bg-[#0b1321]/90 transition hover:-translate-y-1 hover:border-[#4fd1c5]/70">
